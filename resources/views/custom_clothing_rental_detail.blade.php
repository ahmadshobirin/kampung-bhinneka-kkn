                    ...
                    <div class="row">
                        <div class="align-items-center entries">
                            ...
                            <div class="entry-img">
                                ...
                                @else
                                    <img src="{{ URL::asset('uploads/clothing/'.$item->image) }}" alt="{{$item->name}}" class="img-fluid">
                                @endif
                            </div>

                            {{-- <h2 class="entry-title">
                                <a href="{{ route("fe.clothing.detail", $item->id) }}">{{ $item->name }}</a>
                            </h2> --}}
                            ...
                            <h2 class="entry-title">
                                <a href="{{ route('fe.clothing.detail', $item->id) }}">{{ ucfirst($item->name) }}</a>
                            </h2>
                            ...
                            <div class="entry-footer">
                                ...
                                <ul class="cats">
                                    <li><a href="#">Harga {{ $item->price }}</a></li>
                                </ul>

                                <a href="https://wa.me/+6285736575461" class="get-started-btn scrollto">Sewa Sekarang</a>
