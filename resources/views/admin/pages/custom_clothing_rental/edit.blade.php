                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            @endif
                            <form class="form form-vertical" action="{{ route('clothing.update', ['id'=>$data->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf @method('PUT')
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <img id="imgPreview" src="{{ asset('uploads/clothing/'.$data->image) ?? asset('assets/images/no-image.jpg') }}" class="mt-2 mb-2" style="height: 170px">
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="name">Harga</label>
                                                <input type="number" id="price" name="price" class="form-control" value="{{ old('price') ?? $data->price }}"/>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
