                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            @endif
                            <form class="form form-vertical" action="{{ route('umkm.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="nib" name="nib" class="form-control" value="{{ old('nib') }}" placeholder="120197******" maxlength="20" minlength="10"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name" name="name" class="form-control" value="{{ old('name') }}" placeholder="Toko / Warung xxx"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="pic" name="pic" class="form-control" value="{{ old('pic') }}" placeholder="Jhon Doe"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" id="business_type" name="business_type" class="form-control" value="{{ old('business_type') }}" placeholder="Jasa / Dagang xxx"/>
                                        </div>
                                            ...
                                            <fieldset class="form-group">
                                                <select name="demografis_id" class="form-control" required>
                                                    ...
                                                    @foreach ($data as $item)
                                                        <option @if(old('demografis_id') == $item->id) selected @endif value="{{ $item->id }}"> {{  $item->neighborhood }}</option>
                                                    @endforeach
                                                </select>
                                            </fieldset>
                                        </div>
