...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ URL::assset('assets-admin/css/main/app.css') }}" />
    <link rel="stylesheet" href="{{ URL::assset('assets-admin/css/main/app-dark.css') }}" />
    <link
      rel="shortcut icon"
      href="{{ URL::assset('assets-admin/images/logo/favicon.svg') }}"
      type="image/x-icon"
    />
    <link
      rel="shortcut icon"
      href="{{ URL::assset('assets-admin/images/logo/favicon.png') }}"
      type="image/png"
    />
  </head>

  <body>
    <script src="{{ URL::assset('assets-admin/js/initTheme.js') }}"></script>
    <div id="app">
        ...
        <div class="sidebar-wrapper active">
          <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
              <div class="logo">
                <a href="index.html"
                  ><img src="{{ URL::assset('assets-admin/images/logo/logo.svg') }}" alt="Logo" srcset=""
                /></a>
              </div>
    ...
    <script src="{{ URL::assset('assets-admin/js/bootstrap.js') }}"></script>
    <script src="{{ URL::assset('assets-admin/js/app.js') }}"></script>
  </body>
</html>
